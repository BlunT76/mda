...
app.get('/profilPublic', loggedIn, function (req, res) {
...
app.get('/test', function (req, res) {
    ...
    let sqlrequete = `SELECT nomAtelier FROM Ateliers `;// <-- la requete au format mysql, la on selectionne tout dans la table User
